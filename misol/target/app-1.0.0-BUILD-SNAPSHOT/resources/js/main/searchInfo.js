...
var summonerInfoForm = function(){
	...
	summonerInfoHtml += '<div class="summonerIcon">';
	summonerInfoHtml += '	아이콘';
	summonerInfoHtml += '</div>';
	summonerInfoHtml += '<div class="summonerInfo">';
	summonerInfoHtml += '	솬사 정보';
	summonerInfoHtml += '</div>';
...
var searchSummoner = function(searchName) {
	...
	$.ajax({
        ...
        success:function(data){
  		  ...
  		  getProfileIconUrl(data[searchName].profileIconId);
        },
        error:function(e){
        },
        beforeSend:function(){
...
var getProfileIconUrl = function(iconId){
	var profileIconUrl = 'http://ddragon.leagueoflegends.com/cdn/5.2.1/img/profileicon/';
	return profileIconUrl + iconId + '.png';
};
